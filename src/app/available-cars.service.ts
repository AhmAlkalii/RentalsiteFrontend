...
export class AvailableCarsService {
  getAvailableCars() {
    return of([
      {id:1, brand:'Maybach', seats:4, fuelType:'Pb', fuelConsumption:6.8, power:125,price:"$500000",pictureUrl:"https://s3-prod-europe.autonews.com/s3fs-public/styles/800x600/public/maybach_1.jpg"},
      ...
      {id:4, brand:'Tesla Model S', seats:4, fuelType:'Pb', fuelConsumption:6.8, power:125,price:"$50000",pictureUrl:"https://hips.hearstapps.com/hmg-prod/images/2023-tesla-model-s-exterior-654d3a5e814cc.png?crop=0.548xw:0.642xh;0.223xw,0.180xh&resize=768:*"},
